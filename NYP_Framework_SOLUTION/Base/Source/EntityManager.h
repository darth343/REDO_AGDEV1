...
public:
	...
	void SetEntityHolder(EntityBase* Entity);
	EntityBase* GetEntityHolder();

private:
	EntityManager();
	virtual ~EntityManager();

	CSceneNode* CheckChildrenCollision(EntityBase* thisEntity, EntityBase* thatEntity);
	// Check for overlap
	...
	bool CheckAABBCollision(Vector3 Max, Vector3 Min, EntityBase *ThatEntity);
